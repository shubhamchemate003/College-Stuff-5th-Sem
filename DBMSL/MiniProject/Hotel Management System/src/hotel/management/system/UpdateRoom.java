	...
	public UpdateRoom() throws SQLException {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					conn c = new conn();
					ResultSet rs1 = c.s.executeQuery("select * from customer where number LIKE '" + s1 + "'");
				...
				try {
					conn c = new conn();
					ResultSet rs2 = c.s.executeQuery("select * from room where room_number LIKE '" + txt_Room.getText() + "'");
					while (rs2.next()) {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try {
					conn c = new conn();
					String str = "update room set status = '" + txt_Status.getText() + "' where room_number LIKE '"
							+ txt_Room.getText() + "'";
